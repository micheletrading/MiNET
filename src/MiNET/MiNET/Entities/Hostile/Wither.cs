...
namespace MiNET.Entities.Hostile
{
	public class Wither : HostileMob, IAgeable
	{
		...
		public override MetadataDictionary GetMetadata()
		{
			...
			metadata[44] = new MetadataByte(0);
			metadata[45] = new MetadataInt(0);
			metadata[46] = new MetadataInt(0);
			metadata[48] = new MetadataInt(AnimationStep);
			metadata[49] = new MetadataLong(-1);
			metadata[50] = new MetadataLong(-1);
			metadata[51] = new MetadataLong(-1);
			metadata[52] = new MetadataShort((short) (ShowAuora ? 0 : 1));
			metadata[53] = new MetadataFloat(1f);
			metadata[54] = new MetadataFloat(3f);
